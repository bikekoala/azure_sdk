...
class Resources
{
    ...
    const BLOB_BASE_DNS_NAME = 'blob.core.chinacloudapp.cn';
    const QUEUE_BASE_DNS_NAME = 'queue.core.chinacloudapp.cn';
    const TABLE_BASE_DNS_NAME = 'table.core.chinacloudapp.cn';
    ...
    // Xml Namespaces
    const WA_XML_INSTANCE_NAMESPACE = 'http://www.w3.org/2001/XMLSchema-instance';
    ...
    const NC_XML_NAMESPACE   = 'http://schemas.microsoft.com/ServiceHosting/2011/07/NetworkConfiguration';

    // Header values
    const SDK_USER_AGENT                                = 'Azure-SDK-For-PHP/0.4.0';
    const STORAGE_API_LATEST_VERSION                    = '2011-08-18';
    const SM_API_LATEST_VERSION                         = '2014-06-01';
    ...
    const XTAG_ATTRIBUTE_NAME             = 'name';
    const XTAG_ATTRIBUTE_I_TYPE           = 'i:type';
    const XTAG_ATTRIBUTE_XMLNS_I          = 'xmlns:i';
    ...
    const XTAG_CONFIGURATION_SETS         = 'ConfigurationSets';
    const XTAG_CONFIGURATION_SET          = 'ConfigurationSet';
    const XTAG_CONFIGURATION_SET_TYPE     = 'ConfigurationSetType';
    ...
    const XTAG_NETWORK_CONFIGURATION      = 'NetworkConfiguration';
    const XTAG_VIRTUAL_NETWORK_CONFIGURATION = 'VirtualNetworkConfiguration';
    const XTAG_VIRTUAL_NETWORK_SITES      = 'VirtualNetworkSites';
    const XTAG_VIRTUAL_NETWORK_SITE       = 'VirtualNetworkSite';
    const XTAG_VIRTUAL_NETWORK_NAME       = 'VirtualNetworkName';
    const XTAG_SUBNETS                    = 'Subnets';
    const XTAG_SUBNET                     = 'Subnet';
    const XTAG_SUBNET_NAMES               = 'SubnetNames';
    const XTAG_SUBNET_NAME                = 'SubnetName';
    const XTAG_ADDRESS_SPACE              = 'AddressSpace';
    const XTAG_ADDRESS_PREFIX             = 'AddressPrefix';
    const XTAG_DEPLOYMENT                 = 'Deployment';
    const XTAG_DEPLOYMENT_SLOT            = 'DeploymentSlot';
    const XTAG_PERSISTENT_VM_ROLE         = 'PersistentVMRole';
    const XTAG_ROLE                       = 'Role';
    const XTAG_ROLE_LIST                  = 'RoleList';
    const XTAG_ROLE_NAME                  = 'RoleName';
    const XTAG_ROLE_TYPE                  = 'RoleType';
    const XTAG_ROLE_SIZE                  = 'RoleSize';
    const XTAG_HOST_NAME                  = 'HostName';
    const XTAG_USER_NAME                  = 'UserName';
    const XTAG_USER_PASSWORD              = 'UserPassword';
    const XTAG_DISABLE_SSH_PASSWORD_AUTHENTICATION = 'DisableSshPasswordAuthentication';
    const XTAG_PROVISION_GUEST_AGENT      = 'ProvisionGuestAgent';
    const XTAG_DATA_VIRTUAL_HARD_DISKS    = 'DataVirtualHardDisks';
    const XTAG_DATA_VIRTUAL_HARD_DISK     = 'DataVirtualHardDisk';
    const XTAG_DISK_LABEL                 = 'DiskLabel';
    const XTAG_LOGICAL_DISK_SIZE_IN_GB    = 'LogicalDiskSizeInGB';
    const XTAG_OS_VIRTUAL_HARD_DISK       = 'OSVirtualHardDisk';
    const XTAG_MEDIA_LINK                 = 'MediaLink';
    const XTAG_SOURCE_IMAGE_NAME          = 'SourceImageName';
    const XTAG_ACCOUNT_TYPE               = 'AccountType';
    const XTAG_SUBSCRIPTION_CERTIFICATE            = 'SubscriptionCertificate';
    const XTAG_SUBSCRIPTION_CERTIFICATE_PUBLIC_KEY = 'SubscriptionCertificatePublicKey';
    const XTAG_SUBSCRIPTION_CERTIFICATE_THUMBPRINT = 'SubscriptionCertificateThumbprint';
    const XTAG_SUBSCRIPTION_CERTIFICATE_DATA       = 'SubscriptionCertificateData';
    const XTAG_RESTART_ROLE_OPERATION     = 'RestartRoleOperation';
    const XTAG_SHUTDOWN_ROLE_OPERATION    = 'ShutdownRoleOperation';
    const XTAG_START_ROLE_OPERATION       = 'StartRoleOperation';
    const XTAG_OPERATION_TYPE             = 'OperationType';
    const XTAG_POST_SHUTDOWN_ACTION       = 'PostShutdownAction';
    const XTAG_INPUT_ENDPOINTS            = 'InputEndpoints';
    const XTAG_INPUT_ENDPOINT             = 'InputEndpoint';
    const XTAG_LOCAL_PORT                 = 'LocalPort';
    const XTAG_PROTOCOL                   = 'Protocol';
    const XTAG_PORT                       = 'Port';
    const XTAG_COMPUTER_NAME              = 'ComputerName';
    const XTAG_ADMIN_USERNAME             = 'AdminUsername';
    const XTAG_ADMIN_PASSWORD             = 'AdminPassword';
    const XTAG_ENABLE_AUTOMATIC_UPDATES   = 'EnableAutomaticUpdates';
    const XTAG_STATIC_VIRTUAL_NETWORK_IP_ADDRESS = 'StaticVirtualNetworkIPAddress';
